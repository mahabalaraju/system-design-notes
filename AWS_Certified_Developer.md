...
Its integrated with many AWS offerings / services 
 ...
 Custom cookie 
  ...
  Duration-based Cookies 
   ...
   Cookie name is AWSALB for ALB, AWSSELB for CLB 
   
   go to the EC2 > target group > sticky notes.
    
	Cross - Zone load balancing 
	
	withcross zone load balancing: 
	 each load balancer instance distributes evenly across all registered instacnes in all AZ 
...
Https listener: 
 ...
 you can add an optional list of certificate to support multiple domains 
 ...
 SSL - server name indication (SNI) 
  ...
  doesn't work for CLB(older gen) 
